...
<div class="fieldcontain ${hasErrors(bean: tekMessageInstance, field: 'contents', 'error')} required">
	<label for="contents">
		<g:message code="tekMessage.contents.label" default="Contents" />
		<span class="required-indicator">*</span>
	</label>
	<g:textArea name="contents" cols="40" rows="5" maxlength="2000" required="" value="${tekMessageInstance?.contents}"/>
