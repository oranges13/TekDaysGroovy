		...
		<div id="list-tekMessage" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="contents" title="${message(code: 'tekMessage.contents.label', default: 'Contents')}" />
				...
				<g:each in="${tekMessageInstanceList}" status="i" var="tekMessageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: tekMessageInstance, field: "contents")}</td>
