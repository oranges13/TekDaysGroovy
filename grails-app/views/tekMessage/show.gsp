	...
	<body>
		...
		<div id="show-tekMessage" class="content scaffold-show" role="main">
			...
			<ol class="property-list tekMessage">
				...
				<g:if test="${tekMessageInstance?.contents}">
				<li class="fieldcontain">
					<span id="contents-label" class="property-label"><g:message code="tekMessage.contents.label" default="Contents" /></span>
					
						<span class="property-value" aria-labelledby="contents-label"><g:fieldValue bean="${tekMessageInstance}" field="contents"/></span>
